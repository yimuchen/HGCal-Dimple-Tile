...
// Operators
  ...
  inline int
  operator==( const LYSimTrajectoryPoint& right ) const
  { return this == &right; };
...
// Get/Set functions
  ...
  GetMomentum() const { return fMomentum; };
  inline G4StepStatus
  GetStepStatus() const { return fStepStatus; };
  inline G4String
  GetVolumeName() const { return fVolumeName; };
...
inline void*
LYSimTrajectoryPoint::operator new( size_t )
{
...
inline void
LYSimTrajectoryPoint::operator delete( void* aTrajectoryPoint )
{

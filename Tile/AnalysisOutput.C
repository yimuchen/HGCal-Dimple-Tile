...
private:
  ...
  void
  processLine( string line, double& absorptionTile, double& absorptionFiber, double& efficiency )
  {
    ...
    while( getline( ss, field, '\t' ) ){
      if( ctr == 0 ){stringstream temp( field ); temp >> absorptionTile;} else if( ctr == 1 ){stringstream temp( field ); temp >> absorptionFiber;} else if( ctr == 2 ){stringstream temp( field ); temp >> efficiency;} else {}

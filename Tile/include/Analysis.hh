...
public:
  ...
  void
  SetOutputFile( std::string filename ){fOutputFileName = filename;};
  // Set ROOT file name
  void
  SetROOTFile( std::string filename ){fROOTFileName = filename;};
  // Get output file name
  std::string
  GetOutputFileName(){return fOutputFileName;};
  // Get ROOT file name
  std::string
  GetROOTFileName(){return fROOTFileName;};
  ...
  void
  SetInducedMuFiber ( G4double value ){ inducedMuFiber = value; }

...
// Operators
  ...
  inline int
  operator ==( const LYSimTrajectory& right ) const
  { return this == &right; }

// Get/Set functions

  inline G4int
  GetTrackID() const { return fTrackID; }
  inline G4int
  GetParentID() const { return fParentID; }
  inline G4String
  GetParticleName() const { return ParticleName; }
  inline G4double
  GetCharge() const { return PDGCharge; }
  inline G4int
  GetPDGEncoding() const { return PDGEncoding; }
  inline G4ThreeVector
  GetInitialMomentum() const { return initialMomentum; }
...
// Other member functions
  ...
  void
  SetDrawTrajectory( G4bool b ){drawit = b;}
  void
  WLS(){wls = true;}
  void
  SetForceDrawTrajectory( G4bool b ){forceDraw = b;}
  void
  SetForceNoDrawTrajectory( G4bool b ){forceNoDraw = b;}
...
inline void*
LYSimTrajectory::operator new( size_t )
{
...
inline void
LYSimTrajectory::operator delete( void* aTrajectory )
{
